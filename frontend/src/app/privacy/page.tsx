        ...
        <div className="space-y-12 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Razorpay (Payments):</strong> We use Razorpay to process your credit purchases. Razorpay collects your payment information directly and securely. You can find their privacy policy at <a href="https://razorpay.com/privacy/" target="_blank" className="text-[#2563EB] font-semibold hover:underline">razorpay.com/privacy</a>.</li>
