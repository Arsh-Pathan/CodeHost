        ...
        <div className="space-y-12 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Payment Information:</strong> When you purchase credits, certified third-party payment processors handle your payment details. We only receive and store transaction metadata, including payment and order transaction IDs, and the amount of credits purchased. We do not store full credit card numbers, UPI PINs, or other sensitive financial credentials.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Payment Gateway:</strong> We use certified payment processors to handle credit purchases securely. Payment information is entered directly into encrypted payment interfaces.</li>
